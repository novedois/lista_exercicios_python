...
08. Faça um Programa que pergunte quanto você ganha por hora e o número
    ...
    no referido mês.
-------------------------------------------------------------------------
09. Faça um Programa que peça a temperatura em graus Fahrenheit, transforme
...
-------------------------------------------------------------------------
18. Faça um programa que peça o tamanho de um arquivo para download (em
    MB) e a velocidade de um link de Internet (em Mbps), calcule e infor-
    me o tempo aproximado de download do arquivo usando este link (em mi-
    nutos).
-------------------------------------------------------------------------
'''
